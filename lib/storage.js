...
export const DEFAULT_CONFIG = Object.freeze({
    ...
    // Token watcher
    triggerThreshold: 145000,   // tokens; configurable 120000-190000
...
export function updateConfig(patch) {
    ...
    if (patch.triggerThreshold !== undefined) {
        cfg.triggerThreshold = clamp(patch.triggerThreshold, 120000, 190000);
    }
    ...
    if (patch.animeV17 !== undefined) {
        ...
        cfg.animeV17.autonomousSnapshotThreshold = clamp(
            cfg.animeV17.autonomousSnapshotThreshold, 120000, 190000,
        );
